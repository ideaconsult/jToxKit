...
jT.ui.templates['matrix-report-annotation']  = 
"<p>" +
"{{ info }}" +
"<br/>" +
"<strong>Rationale for {{ rationaleType }}</strong><br/>" +
"{{ rationaleContent }}" +
"</p>" +
""; // end of matrix-report-annotation 

jT.ui.templates['matrix-report-feature']  = 
"<h4>{{ title }}</h4>" +
""; // end of matrix-report-feature 

jT.ui.templates['matrix-report-substance']  = 
"<h3>Substance {{ number }}: {{ name }}</h3>" +
""; // end of matrix-report-substance 
